...
export default function Ambassador(){
    return(
        <div className=" max-w-[1240px] mx-auto px-16 my-6 grid md:grid-cols-2 ">
            <div className=" text-[#1b50bb]">
                ...
                <div className="bg-[#f9d108] text-[14px] text-center px-20 py-3">
                    ...
                    <span className="text-end px-0">Motun Marteen, CEO, Elytse</span>
                </div>
            </div>
            <div className="ml-4 text-white">
                <div className="bg-[#004DE6] mt-16 py-3 px-3 ">
                    <h1 className="text-6xl w-[6rem] ">Become An Elytse's Ambassador</h1>
